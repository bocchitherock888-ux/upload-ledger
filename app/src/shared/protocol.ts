...
export interface FileCandidate extends FileMetadata {
  clientFileId: UUID;
}
...
export interface CommandPayloads {
  ...
  CAPTURE_ABORT: SessionReference & {
    reason: "read_failed" | "source_changed" | "source_gone" | "user_cancelled";
  };
  ...
  UI_MANUAL_ABORT: SessionReference & {
    reason: "read_failed" | "source_changed" | "source_gone" | "user_cancelled";
  };
  ...
  UI_MARK_OBJECT_CORRUPT: {
    recordId: UUID;
    reason: "missing_chunk" | "size_mismatch" | "hash_mismatch";
  };
