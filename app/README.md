...
单文件上限 50 MiB，单批最多 100 个文件 / 200 MiB；资料库默认 1 GiB，可调至 5 GiB。支持顶层网页的标准文件选择，以及逐站点开启的拖放。更多格式、权限与恢复说明见 [使用指南](implementation/USAGE.md)。
...
使用 Node 24。浏览器回归、性能数据和兼容范围见 [测试报告](implementation/TEST_EVIDENCE.md)。
